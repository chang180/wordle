...
<body style="touch-action: pan-y">
    <main x-data="game" @keyup.window="onKeyPress($event.key)">
        <div id="game-wrap">
            <header>
                <h1 aria-label="Wordle" class="svg_img">
                    <a href="/">
                        <img id="logo" src="{{ asset('images/wordle.svg') }}">
                    </a>
                </h1>
        ...
        <div id="keyboard"
            @click.stop="$event.target.closest('button') && onKeyPress($event.target.closest('button').dataset.key)">
